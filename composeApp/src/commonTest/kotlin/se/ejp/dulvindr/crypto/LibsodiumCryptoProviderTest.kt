...
/**
 * Tests for LibsodiumCryptoProvider.
 *
 * Note: These tests are excluded from Android unit tests via build.gradle.kts
 * because Android unit tests cannot load native libraries. Use instrumented
 * tests (androidTest) to test crypto functionality on Android devices.
 */
class LibsodiumCryptoProviderTest {
     ...
     */
    private suspend fun initializeLibsodium() {
    ...
    @Test
    fun testEncryptionProducesDifferentCiphertexts() = runTest {
        initializeLibsodium()
        val aliceKeyPair = crypto.generateKeyPair()
        val bobKeyPair = crypto.generateKeyPair()
    ...
    @Test
    fun testShortCiphertextFails() = runTest {
        initializeLibsodium()
        val aliceKeyPair = crypto.generateKeyPair()
        val bobKeyPair = crypto.generateKeyPair()
    ...
    @Test
    fun testUnicodeMessages() = runTest {
        initializeLibsodium()
        val aliceKeyPair = crypto.generateKeyPair()
        val bobKeyPair = crypto.generateKeyPair()
